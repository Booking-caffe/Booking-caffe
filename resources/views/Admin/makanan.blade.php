...
@section('content')
    ...
    <div>
        ...
        <div
            ...
            <!-- ADD BUTTON -->
            <a href="{{ route('formMenu', ['kategori' => 'makanan']) }}"
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-sm mt-8">
            ...
            <div class="flex items-center gap-2">
                ...
                {{ $makanan->onFirstPage() ? 'bg-gray-300 cursor-not-allowed' : 'bg-primary hover:bg-primary/90 text-white' }}">
                    Previous
                </a>
                ...
                <a href="{{ $makanan->nextPageUrl() ?? '#' }}"
                    class="px-3 py-1 rounded
                {{ $makanan->hasMorePages() ? 'bg-primary hover:bg-primary/90 text-white' : 'bg-gray-300 cursor-not-allowed' }}">
                    Next
                </a>
