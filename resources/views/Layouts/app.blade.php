            ...
            <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <div class="relative group">
                        <button class="text-text-light dark:text-text-dark hover:text-primary dark:hover:text-white transition-colors duration-300 font-medium flex items-center gap-1">
                            Menu
                            <span class="material-symbols-outlined text-sm">expand_more</span>
                        </button>

                        <!-- Dropdown Content -->
                        <div class="absolute left-0 mt-2 w-40 bg-white dark:bg-card-dark shadow-lg rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                            
                            <a href="{{ route('menu-makanan') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white">Makanan</a>

                            <a href="{{ route('menu-minuman') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white">Minuman</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div class="md:col-span-1">
                ...
                <p class="text-text-muted-light dark:text-text-muted-dark text-sm mb-4">Cafe adalah tempat bersantai untuk semua kalangan dari anak muda sampai di kalangan orang tua juga.</p>
